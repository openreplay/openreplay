...
func (e *Router) createSpot(w http.ResponseWriter, r *http.Request) {
	...
	if err = e.services.ObjStorage.Upload(bytes.NewReader(previewImage), previewName, "image/jpeg", objectstorage.NoContentEncoding, objectstorage.NoCompression); err != nil {
