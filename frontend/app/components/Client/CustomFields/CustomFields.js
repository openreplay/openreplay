        ...
        return (
            <div>
                <SlideModal
                    ...
                    content={
                        showModal && <CustomFieldForm onClose={this.closeModal} onSave={this.save} onDelete={() => this.removeMetadata(field)} />
                    }
                ...
                <div className={styles.tabHeader}>
                    ...
                    <div style={{ marginRight: '15px' }}>
                        <SiteDropdown value={currentSite && currentSite.id} onChange={this.onChangeSelect} />
                    </div>
