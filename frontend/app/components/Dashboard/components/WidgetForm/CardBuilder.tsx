...
import {
  Card, Input, Space, Button, Segmented, Alert,
} from 'antd';
...
function PredefinedMessage() {
  return <Alert message="Drilldown or filtering isn't supported on this legacy card." type="warning" showIcon closable className="border-transparent rounded-lg" />;
}
...
const PathAnalysisFilter = observer(({ metric }: any) => (
  <Card
    styles={{
      ...
      header: {
        padding: '4px 20px', fontSize: '14px', fontWeight: 'bold', borderBottom: 'none',
      },
    }}
