...
function Avatar_icn_avatar12(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" width={`${width}px`} height={`${height}px`}>
      <path d="M20 15c0 .55-.22 1.05-.59 1.41-.36.37-.86.59-1.41.59v5h-7c1.66 0 3-1.34 3-3v-1c0-1.66-1.34-3-3-3v-.04c.16.03.33.04.5.04 1.93 0 3.5-1.57 3.5-3.5S13.43 8 11.5 8c-.74 0-1.44.23-2 .64-.56-.41-1.26-.64-2-.64-.54 0-1.05.12-1.5.35V8c0-3.31 2.69-6 6-6 1.66 0 3.16.67 4.24 1.76A5.944 5.944 0 0 1 18 8v5c.55 0 1.05.22 1.41.59.37.36.59.86.59 1.41z" opacity=".3" />
