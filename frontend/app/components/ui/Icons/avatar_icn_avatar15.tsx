...
function Avatar_icn_avatar15(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" width={`${width}px`} height={`${height}px`}>
      <path d="M16.8 10.8 15.6 12H14v.9l-.3 2.7-.2.9-.4 3.5h-2.2l-.4-3.5-.2-.8-.3-2.8V12H8.4l-1.2-1.2.2-.4 3.6.6 1-1 1 1 3.6-.6zM16 7H8c0-2.1 2.1-3 4-3s4 .9 4 3z" opacity=".3" />
