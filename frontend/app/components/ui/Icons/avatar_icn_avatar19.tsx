...
function Avatar_icn_avatar19(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" baseProfile="basic" width={`${width}px`} height={`${height}px`}>
      <path d="M19 13c1.1 0 2 .9 2 2s-.9 2-2 2h-.08A6.965 6.965 0 0 1 12 23.02c-3.53 0-6.44-2.6-6.92-6H5c-1.1 0-2-.9-2-2s.9-2 2-2L19 13zM5 9h14v4H5zM5 9 2.75 7.75l2.125-1.875-1-2.375 3.375.375 2.92-2.855L12 2.875l3.787-1.855.713 3.355L20 3l-1 2.5L22 7l-3 2z" opacity=".35" />
