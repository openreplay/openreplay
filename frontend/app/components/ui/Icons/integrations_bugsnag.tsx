...
function Integrations_bugsnag(props: Props) {
  ...
  return (
    <svg viewBox="0 0 58 80" fill="none" width={`${width}px`} height={`${height}px`} fill={`${fill}`}>
      <path d="M28.943 55.123a3.228 3.228 0 1 0 0-6.455 3.228 3.228 0 0 0 0 6.456Z" fill="#303F9F" />
