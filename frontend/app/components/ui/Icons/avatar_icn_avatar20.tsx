...
function Avatar_icn_avatar20(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" width={`${width}px`} height={`${height}px`}>
      <path d="M21 13c0-1.6-1.2-3.3-3-4 0-2.8-2.1-6-6-6S6 6.2 6 9c-1.8.7-3 2.4-3 4 0 2.7 2.6 4.4 5.2 4.9.5 1.2 2 2.1 3.8 2.1s3.3-.9 3.8-2.1c2.6-.5 5.2-2.2 5.2-4.9z" opacity=".3" />
