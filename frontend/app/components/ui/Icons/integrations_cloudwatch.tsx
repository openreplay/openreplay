...
function Integrations_cloudwatch(props: Props) {
  ...
  return (
    <svg viewBox="3.62 8.78 64 64" width={`${width}px`} height={`${height}px`} fill={`${fill}`}>
      <path d="M35.605 72.78 63.9 52.803l-28.266-4.13-28.296 4.16z" fill="#b7ca9d" />
      ...
      <path d="m46.686 33.98-19.52 22.68-6.62-2.004V12.1l6.62-3.3z" fill="#4c622c" />
