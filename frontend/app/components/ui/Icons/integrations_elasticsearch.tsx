...
function Integrations_elasticsearch(props: Props) {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m100.085 110.364 57.043 26.119 57.669-50.565a64.312 64.312 0 0 0 1.253-12.746c0-35.52-28.834-64.355-64.355-64.355-21.313 0-41.162 10.447-53.072 27.998l-9.612 49.73 11.074 23.82z"
        fill="#F4BD19"
      />
      <path
...
export default Integrations_elasticsearch;
