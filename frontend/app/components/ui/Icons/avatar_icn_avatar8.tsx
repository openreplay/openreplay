...
function Avatar_icn_avatar8(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" width={`${width}px`} height={`${height}px`}>
      <path d="M18 10v11h-.13c-.44-1.73-2.01-3-3.87-3h-4c-1.86 0-3.43 1.27-3.87 3H6V10c0-3.31 2.69-6 6-6 1.66 0 3.16.67 4.24 1.76A5.944 5.944 0 0 1 18 10z" opacity=".3" />
