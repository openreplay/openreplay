...
function Integrations_stackdriver(props: Props) {
  ...
  return (
    <svg viewBox="0 0 65 57" fill="#fff" stroke="#000" strokeLinecap="round" strokeLinejoin="round" fontFamily="Roboto" fontSize="14" textAnchor="middle" width={`${width}px`} height={`${height}px`} fill={`${fill}`}>
      ...
      <symbol id="a" overflow="visible">
        <g stroke="none">
          ...
          <path d="M47.83 55.172 31.904 27.618 47.91 0 64 27.585z" fill="#8cc63f" />
        </g>
      </symbol>
    </svg>
  );
