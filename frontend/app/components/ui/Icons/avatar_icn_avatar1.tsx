...
function Avatar_icn_avatar1(props: Props) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="#27A2A8" width={`${width}px`} height={`${height}px`}>
      <path d="M20.4 12.11c-1.7 4.2-4.1 5-5.9 5.1-2.5.2-2.5-.7-2.5-.7l-2-.1c0 1.3 1.3 2.29 3 2.59v1.3c-1.6-.1-3-1.3-4-2.29-1.4.5-3.8-.5-3-3 .4-1.1 1.2-1.6 1.9-1.8.1.1.2.3.3.4 1 1.5 2.5 2.4 3.9 2.4.6 0 1.2-.2 1.7-.5.5-.4.9-.8 1.1-1.4 2-.7 4.7-1.6 5.5-2z" opacity=".3" />
      <path d="M12.6 13.91c-.7.5-1.9-.1-2.8-1.4-.8-1.3-1-2.6-.3-3.09.7-.5 1.9.1 2.8 1.39.9 1.2 1 2.6.3 3.1z" opacity=".3" />
