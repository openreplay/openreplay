...
function Network(props: Props) {
  ...
  return (
    <svg viewBox="0 0 13 14" width={`${width}px`} height={`${height}px`}>
      <g>
        <path d="M3.649 4.875a.396.396 0 1 0 0-.792.396.396 0 0 0 0 .792ZM2.461 4.48a.396.396 0 1 1-.793 0 .396.396 0 0 1 .793 0Z" fillOpacity=".6" />
      ...
      <defs><clipPath id="a"><path transform="translate(.084 .914)" d="M0 0h12.676v12.676H0z" /></clipPath></defs>
    </svg>
  );
}
