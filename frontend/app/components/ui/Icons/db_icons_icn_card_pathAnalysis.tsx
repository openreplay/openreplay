    ...
    >
      <g>
        ...
        <path
          opacity=".3"
          fill="#9299D3"
          d="M12.546 1.216h45.238v20.077H12.546z"
        />
        <path
          opacity=".7"
          fill="#8ED4DA"
          fillOpacity=".8"
          d="M12.546 65.407h45.238V70.5H12.546z"
        />
        <path
          opacity=".3"
        ...
        />
        <path
          d="M12.702 35.184V21.878c2.043.353 4.527.878 7.061 1.502 9.026 2.223 14.544 9.72 20.496 16.859 6.747 8.092 13.713 9.724 17.056 10.598v13.462c-3.893-.375-7.645-2.185-10.511-4.06-3.1-2.026-5.321-5.064-7.44-8.101-14.562-20.874-22.461-16.173-26.662-16.954Z"
          fill="#8ED4DA"
          stroke="#000"
          strokeWidth=".5"
          strokeLinecap="round"
        ...
        />
        <path
          d="M23.229 29.997c2.862 1.875 8.296 6.324 13.174 11.842 3.01 3.405 8.616 9.119 15.247 10.066"
          stroke="#000"
          strokeWidth=".5"
          strokeLinecap="round"
        />
        <path
          d="M30.444 38.934c.423.277 3.012 2.665 3.734 3.481 2.184 2.47 5.013 5.427 9.55 8.737"
          stroke="#000"
          strokeWidth=".2"
          strokeLinecap="round"
        />
