...
function Integrations_vuejs(props: Props) {
  ...
  return (
    <svg viewBox="0 0 120 120" width={`${width}px`} height={`${height}px`} fill={`${fill}`}>
      ...
      <path d="M87.83 20h18.55L60 100 13.62 20H49.1L60 38.55 70.67 20z" fill="#41b883" />
      <path d="M13.62 20 60 100l46.38-80H87.83L60 68 31.94 20z" fill="#41b883" />
      <path d="M31.94 20 60 68.23 87.83 20H70.67L60 38.55 49.1 20z" fill="#35495e" />
    </svg>
  );
}
