...
export const REPORT = {
  ...
  method: {
    ...
    scoring:
      'Dimension scores are 0–100 composites mapped from Nielsen’s usability heuristics (see each dimension). Severity: P0 blocks task completion, P1 significant friction, P2 recoverable.',
    limits:
