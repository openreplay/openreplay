...
const Prism = (function (e) {
  ...
  var r = {
      ...
      clone: function e(t, n) {
        ...
        switch (((n = n || {}), r.util.type(t))) {
          case 'Object':
            ...
            for (const i in ((a = {}), (n[s] = a), t)) t.hasOwnProperty(i) && (a[i] = e(t[i], n));
            return a;
          case 'Array':
            return (
              (s = r.util.objId(t)),
    ...
    languages: {
      ...
      insertBefore(e, t, n, a) {
        const s = (a = a || r.languages)[e];
        const i = {};
        for (const o in s) {
          if (s.hasOwnProperty(o)) {
            if (o == t) for (const l in n) n.hasOwnProperty(l) && (i[l] = n[l]);
      ...
      DFS: function e(t, n, a, s) {
        ...
        for (const o in t) {
          if (t.hasOwnProperty(o)) {
            n.call(t, o, t[o], a || o);
            const l = t[o];
            const u = r.util.type(l);
            u !== 'Object' || s[i(l)]
              ? u !== 'Array' || s[i(l)] || ((s[i(l)] = !0), e(l, n, o, s))
    ...
    highlightElement(t, n, a) {
      const s = r.util.getLanguage(t);
      const i = r.languages[s];
      r.util.setLanguage(t, s);
      let o = t.parentElement;
      o && o.nodeName.toLowerCase() === 'pre' && r.util.setLanguage(o, s);
      const l = {
        element: t, language: s, grammar: i, code: t.textContent,
      };
      function u(e) {
        (l.highlightedCode = e),
    ...
    for (const d in n) {
      if (n.hasOwnProperty(d) && n[d]) {
        ...
        for (let m = 0; m < p.length; ++m) {
          ...
          for (
            let x = h.pattern || h, k = a.next, w = l;
  ...
  function l() {
    ...
    const t = { value: null, prev: e, next: null };
    (e.next = t), (this.head = e), (this.tail = t), (this.length = 0);
  }
  function u(e, t, n) {
    const a = t.next;
    const r = { value: n, prev: t, next: a };
  ...
  if (
    ...
    const p = document.readyState;
    p === 'loading' || (p === 'interactive' && c && c.defer)
...
(function () {
  if (void 0 !== Prism && typeof document !== 'undefined') {
    ...
    const t = 'data-src-status';
    const n = 'loading';
    const a = 'loaded';
    const r = `pre[data-src]:not([${
      t
    }="${
      a
    }"]):not([${
    ...
    Prism.hooks.add('before-highlightall', (e) => {
      e.selector += `, ${r}`;
    }),
    Prism.hooks.add('before-sanity-check', (s) => {
      const i = s.element;
      if (i.matches(r)) {
        (s.code = ''), i.setAttribute(t, n);
        const o = i.appendChild(document.createElement('CODE'));
        o.textContent = 'Loading…';
        const l = i.getAttribute('data-src');
        let u = s.language;
        if (u === 'none') {
          const g = (/\.(\w+)$/.exec(l) || [, 'none'])[1];
          u = e[g] || g;
        }
        Prism.util.setLanguage(o, u), Prism.util.setLanguage(i, u);
        const c = Prism.plugins.autoloader;
        c && c.loadLanguages(u),
        (function (e, t, n) {
