...
export function mapIphoneModel(modelName: string) {
  ...
  if (iPhone12Pro.includes(modelName)) {
    return { svg: iPhone12ProSvg, styles: screenResolutions.iPhone12Pro } as const;
  } else if (iPhone12ProMax.includes(modelName)) {
    return { svg: iPhone12ProMaxSvg, styles: screenResolutions.iPhone12ProMax } as const;
  } else if (iPhone14Pro.includes(modelName)) {
    return { svg: iphone14ProSvg, styles: screenResolutions.iPhone14Pro } as const;
  } else if (iPhone14ProMax.includes(modelName)) {
    return { svg: iphone14ProMaxSvg, styles: screenResolutions.iPhone14ProMax } as const;
  } else {
    return { svg: iPhone12ProSvg, styles: screenResolutions.iPhone12Pro} as const; // Default fallback
  }
}
