...
const universalAndroid = (width: number, height: number) => {
  ...
  const cameraStyle =
    `width:${dot}px;height:${dot}px;background:#111921;background:conic-gradient(from 315deg,#111921,#2E303D);border-radius:50%;position:absolute;top:${scale*10}px;left:50%;transform:translateX(-50%);z-index:9`
