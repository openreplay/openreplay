  ...
  readMessage(): RawMessage | null {
    ...
    switch (tp) {
      ...
      case 51: {
        ...
        const nameKey = this.readUint();
        if (nameKey === null) {
          return resetPointer();
        }
        const valueKey = this.readUint();
        if (valueKey === null) {
          return resetPointer();
        }
        return {
      ...
      case 53: {
        ...
        const ttfb = this.readUint();
        if (ttfb === null) {
          return resetPointer();
        }
        const headerSize = this.readUint();
        if (headerSize === null) {
          return resetPointer();
        }
        const encodedBodySize = this.readUint();
        if (encodedBodySize === null) {
          return resetPointer();
        }
        const decodedBodySize = this.readUint();
        ...
        const initiator = this.readString();
        if (initiator === null) {
          return resetPointer();
        }
        return {
      ...
      case 57: {
        ...
        const descriptors = this.readString();
        if (descriptors === null) {
          return resetPointer();
        }
        return {
      ...
      case 68: {
        ...
        const normalizedX = this.readUint();
        if (normalizedX === null) {
          return resetPointer();
        }
        const normalizedY = this.readUint();
        if (normalizedY === null) {
          return resetPointer();
        }
        return {
      ...
      case 83: {
        ...
        const transferredBodySize = this.readUint();
        if (transferredBodySize === null) {
          return resetPointer();
        }
        return {
      ...
      case 84: {
        const chType = this.readString();
        if (chType === null) {
          return resetPointer();
        }
        const channelName = this.readString();
        if (channelName === null) {
          return resetPointer();
        }
        const data = this.readString();
        ...
        const messageType = this.readString();
        if (messageType === null) {
          return resetPointer();
        }
        return {
      ...
      case 113: {
        const selectionStart = this.readUint();
        if (selectionStart === null) {
          return resetPointer();
        }
        const selectionEnd = this.readUint();
        if (selectionEnd === null) {
          return resetPointer();
        }
        const selection = this.readString();
        if (selection === null) {
          return resetPointer();
        }
        return {
      ...
      case 116: {
        ...
        const transferredSize = this.readUint();
        if (transferredSize === null) {
          return resetPointer();
        }
        const cached = this.readBoolean();
        if (cached === null) {
          return resetPointer();
        }
        return {
      ...
      case 121: {
        ...
        const actionTime = this.readUint();
        if (actionTime === null) {
          return resetPointer();
        }
        return {
      ...
      case 122: {
        ...
        const documentTitle = this.readString();
      ...
      case 101: {
        ...
        const valueMasked = this.readBoolean();
        if (valueMasked === null) {
          return resetPointer();
        }
        const label = this.readString();
      ...
      case 106: {
        ...
        const direction = this.readString();
        if (direction === null) {
          return resetPointer();
        }
        return {
      ...
      case 111: {
        ...
        const contextString = this.readString();
        if (contextString === null) {
          return resetPointer();
        }
        const context = this.readString();
        if (context === null) {
          return resetPointer();
        }
        const payload = this.readString();
