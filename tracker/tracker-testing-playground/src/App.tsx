...
function App() {
  ...
  if (!sRen) return (
    <div><button id="testrender" onClick={() => setRen(true)}>test</button> test</div>
  )
  ...
  return (
    <>
    <button id="testrender" onClick={() => setRen(false)}>test rerender</button>
    <button onClick={testAPI}>test api</button>
    <button onClick={testAPIError}>test api error</button>
    <button id="redcounter" onClick={incrementRedux}>test Redux {counter}</button>
