...
{{- else }}
{{- $ep := include "openreplay.s3Endpoint" . | trimSuffix "/" }}
{{- if $ep }}
{{- $ep }}/{{.Values.global.s3.assetsBucket}}
{{- else }}
{{- printf "https://s3.%s.amazonaws.com" .Values.global.s3.region | trimSuffix "/" }}/{{.Values.global.s3.assetsBucket}}
{{- end }}
{{- end }}
{{- end }}
