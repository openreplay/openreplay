...
# This wrapper will help to check the sed, and use the correct version="v1.13.0"
# Ref: https://stackoverflow.com/questions/37639496/how-can-i-check-the-version="v1.13.0"
function is_gnu_sed(){
