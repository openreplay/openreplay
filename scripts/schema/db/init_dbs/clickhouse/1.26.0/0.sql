SELECT throwIf((SELECT openreplay_version()) != 'v1.25.0', 'Previous version does not match v1.25.0') AS check;
...
CREATE OR REPLACE FUNCTION openreplay_version AS() -> 'v1.26.0';
