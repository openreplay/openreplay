    ...
    with ch_client.ClickHouseClient() as cur:
        main_query = cur.format(query=f"""\
                SELECT min(events.`$properties`.dom_building_time::Int64) AS dom_building_time_min,
                       ...
                       quantile(0.90)(events.`$properties`.dom_building_time::Int64) AS dom_building_time_p790,
                       ...
                       quantile(0.90)(events.`$properties`.ttfb::Int64)              AS ttfb_p790,
                       ...
                       quantile(0.90)(events.`$properties`.speed_index::Int64)       AS speed_index_p790,
