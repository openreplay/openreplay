...
ALTER TABLE experimental.autocomplete
    MODIFY TTL _timestamp + INTERVAL 1 MONTH;
ALTER TABLE experimental.events
    MODIFY TTL datetime + INTERVAL 3 MONTH;
ALTER TABLE experimental.resources
    MODIFY TTL datetime + INTERVAL 3 MONTH;
ALTER TABLE experimental.sessions
    MODIFY TTL datetime + INTERVAL 3 MONTH;
ALTER TABLE experimental.user_favorite_sessions
    MODIFY TTL _timestamp + INTERVAL 3 MONTH;
ALTER TABLE experimental.user_viewed_sessions
    MODIFY TTL _timestamp + INTERVAL 3 MONTH;
ALTER TABLE experimental.user_viewed_errors
    MODIFY TTL _timestamp + INTERVAL 3 MONTH;
ALTER TABLE experimental.issues
    MODIFY TTL _timestamp + INTERVAL 3 MONTH;