...
CREATE TABLE IF NOT EXISTS product_analytics.events_v2
(
    project_id                  UInt16,
    event_id                    UUID,
    "$event_name"               String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS product_analytics.events_mirror_mv
    TO product_analytics.events_v2 AS
SELECT *
