SELECT throwIf((SELECT openreplay_version()) != 'v1.27.0-ee', 'Previous version does not match v1.27.0-ee') AS check;
...
CREATE OR REPLACE FUNCTION openreplay_version AS() -> 'v1.28.0-ee';
