...
CREATE TABLE default.sessions_metadata_temp
(
    session_id      UInt64,
    project_id      UInt32,
...
INSERT INTO default.sessions_metadata_temp(session_id, project_id, tracker_version, rev_id, user_uuid, user_os,
                                           user_os_version,
                                           user_browser, user_browser_version, user_device, user_device_type,
                                           user_country,
                                           datetime, user_id, user_anonymous_id, metadata_1, metadata_2, metadata_3,
                                           metadata_4,
                                           metadata_5, metadata_6, metadata_7, metadata_8, metadata_9, metadata_10)
SELECT session_id,
       project_id,
       tracker_version,
       rev_id,
       ...
       metadata_9,
       metadata_10
FROM default.sessions_metadata;

DROP TABLE default.sessions_metadata;
RENAME TABLE default.sessions_metadata_temp TO default.sessions_metadata;