...
def create_events_detailed_table(creds_file, table_id):
    ...
    bigquery.SchemaField("longtasks_context", "FLOAT64"),
    bigquery.SchemaField("longtasks_containertype", "FLOAT64"),
    bigquery.SchemaField("longtasks_containersrc", "STRING"),
    bigquery.SchemaField("longtasks_containerid", "STRING"),
    bigquery.SchemaField("longtasks_containername", "FLOAT64"),
    bigquery.SchemaField("setnodeurlbasedattribute_id", "FLOAT64"),
