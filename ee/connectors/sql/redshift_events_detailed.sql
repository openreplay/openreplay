...
(
	sessionid                                 BIGINT,
	adoptedssreplaceurlbased_sheet_id         BIGINT,
    adoptedssreplaceurlbased_text             VARCHAR(300),
    adoptedssreplaceurlbased_base_url         VARCHAR(300),
    adoptedssreplace_sheet_id                 BIGINT,
    adoptedssreplace_text                     VARCHAR(300),
    adoptedssinsertruleurlbased_sheet_id      BIGINT,
    adoptedssinsertruleurlbased_rule          VARCHAR(300),
    adoptedssinsertruleurlbased_index         BIGINT,
    adoptedssinsertruleurlbased_base_url      VARCHAR(300),
    adoptedssinsertrule_sheet_id              BIGINT,
    adoptedssinsertrule_rule                  VARCHAR(300),
    adoptedssinsertrule_index                 BIGINT,
    adoptedssdeleterule_sheet_id              BIGINT,
    adoptedssdeleterule_index                 BIGINT,
    adoptedssaddowner_sheet_id                BIGINT,
    adoptedssaddowner_id                      BIGINT,
    adoptedssremoveowner_sheet_id             BIGINT,
    adoptedssremoveowner_id                   BIGINT,
    ...
    inputchange_id                            BIGINT,
    inputchange_value                         VARCHAR(300),
    inputchange_value_masked                  BOOLEAN,
    inputchange_label                         VARCHAR(300),
    inputchange_hesitation_time               BIGINT,
    inputchange_input_duration                BIGINT,
    ...
    mousethrashing_timestamp                  BIGINT,
    ...
    partitionedmessage_part_no                BIGINT,
    partitionedmessage_part_total             BIGINT,
    ...
    resourcetiming_header_size                BIGINT,
    resourcetiming_encoded_body_size          BIGINT,
    resourcetiming_decoded_body_size          BIGINT,
    resourcetiming_url                        VARCHAR(300),
    resourcetiming_initiator                  VARCHAR(300),
    resourcetiming_transferred_size           BIGINT,
    resourcetiming_cached                     BOOLEAN,
    selectionchange_selection_start           BIGINT,
    selectionchange_selection_end             BIGINT,
    selectionchange_selection                 VARCHAR(300),
	sessiondisconnect                         BOOLEAN,
	sessiondisconnect_timestamp               BIGINT,
    sessionend_timestamp                      BIGINT,
    sessionend_encryption_key                 VARCHAR(300),
    sessionsearch_timestamp                   BIGINT,
    sessionsearch_partition                   BIGINT,
    ...
    unbindnodes_total_removed_percent         BIGINT,
	useranonymousid_id                        VARCHAR(300),
	userid_id                                 VARCHAR(300),
	vuex_mutation                             VARCHAR(300),
	vuex_state                                VARCHAR(300),
    loadfontface_parent_id                    BIGINT,
    loadfontface_family                       VARCHAR(300),
    loadfontface_source                       VARCHAR(300),
    loadfontface_descriptors                  VARCHAR(300),
    ...
    setnodeattributedict_id                   BIGINT,
    setnodeattributedict_name_key             BIGINT,
    setnodeattributedict_value_key            BIGINT,
    ...
    zustand_mutation                          VARCHAR(300),
    zustand_state                             VARCHAR(300),
